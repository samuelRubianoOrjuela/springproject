...
INSERT INTO direccion (id_direccion, tipo_direccion, direccion, descripcion, linea_direccion1, linea_direccion2, id_ciudad) 
VALUES 
(1, 'Oficina', 'Calle Falsa 123', 'Oficina principal', 'Calle Falsa 123', 'Apto 4B', 1),
(2, 'Sucursal', 'Avenida Paulista 1000', 'Sucursal principal', 'Avenida Paulista 1000', NULL, 2);
...
VALUES 
(1, 'Cliente A', 'Luis', 'Fernández', '1234', '5678', 1, 1, 1, 10000.00),
(2, 'Cliente B', 'Marta', 'López', '5678', '1234', 2, 2, 2, 20000.00);
