...
INSERT INTO cliente (id_cliente, nombre_cliente, nombre_contacto, apellido_contacto, fax, telefono, id_ciudad, id_direccion, id_empleado_rep_ventas, limite_credito) VALUES (1, 'Cliente A', 'Luis', 'Fernández', '1234', '5678', 1, 1, 1, 10000.00);
INSERT INTO cliente (id_cliente, nombre_cliente, nombre_contacto, apellido_contacto, fax, telefono, id_ciudad, id_direccion, id_empleado_rep_ventas, limite_credito) VALUES (2, 'Cliente B', 'Marta', 'López', '5678', '1234', 2, 2, 2, 20000.00);
